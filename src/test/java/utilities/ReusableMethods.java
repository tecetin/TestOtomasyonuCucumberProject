...
//    protected static ExtentTest extentTest;
    private static WebDriverWait wait = new WebDriverWait(DriverParallel.getDriver(), Duration.ofSeconds(10));

    public static Sheet excelOku(String path, String page) throws IOException {
    ...
    public static void alertAccept() {
        DriverParallel.getDriver().switchTo().alert().accept();
    }

    //Alert DISMISS
    public static void alertDismiss() {
        DriverParallel.getDriver().switchTo().alert().dismiss();
    }

    //Alert getText()
    public static void alertText() {
        DriverParallel.getDriver().switchTo().alert().getText();
    }

    //Alert promptBox
    public static void alertprompt(String text) {
        DriverParallel.getDriver().switchTo().alert().sendKeys(text);
    }
    ...
    public static void switchToWindow(int sayi) {
        List<String> tumWindowHandles = new ArrayList<String>(DriverParallel.getDriver().getWindowHandles());
        DriverParallel.getDriver().switchTo().window(tumWindowHandles.get(sayi));
    }
    ...
    public static void window(int sayi) {
        DriverParallel.getDriver().switchTo().window(DriverParallel.getDriver().getWindowHandles().toArray()[sayi].toString());
    }

    //Visible Wait
    public static void visibleWait(WebElement element, int sayi) {
        WebDriverWait wait = new WebDriverWait(DriverParallel.getDriver(), Duration.ofSeconds(sayi));
    ...
    public static void sayfaSS(String screenshotIsmi) {
        ...
        DriverParallel.getDriver().manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);

        // 1.adim TakesScreenShot objesi olusturun
        TakesScreenshot tss = (TakesScreenshot) DriverParallel.getDriver();
    ...
    public static String sayfaSSBase64() {
        ...
        return ((TakesScreenshot) DriverParallel.getDriver()).getScreenshotAs(OutputType.BASE64);
    }
    ...
    public static void WEResmi(WebElement element) {
        ...
        WebDriverWait wait = new WebDriverWait(DriverParallel.getDriver(), Duration.ofSeconds(20));
        wait.until(ExpectedConditions.visibilityOf(element));
